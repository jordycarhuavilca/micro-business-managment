...
import com.hotelpe.HotelPe_Backend.service.AwsS3Service;
...
public class RoomService implements IRoomService {
    ...
    @Override
    public Response addNewRoom(MultipartFile photo, String roomType, Double roomPrice, String description) {
        ...
        try {
            ...
            response.setMessage("Error al guardar una habitacion " + e.getMessage());
        }
        return response;
    }
    ...
    public Response deleteRoom(int roomId) {
        ...
        try {
            roomRepository.findById((long) roomId).orElseThrow(() -> new OurException("Room Not Found"));
    ...
    @Override
    public Response updateRoom(int roomId, String description, String roomType, Double roomPrice, MultipartFile photo) {
        Response response = new Response();
